        ...
        <div class="flex flex-col w-full h-full">
            ...
            <div class="flex max-w-full max-h-[783px] flex-1 gap-x-20 mx-15 mt-10">
                <div class="w-full h-full">
                    <h2 class="font-semibold text-center text-xl mb-2">CADASTRAR NOVO AVISO:</h2>
                    <div class="w-full h-full rounded-2xl shadow-xl bg-sky-600/35 overflow-y-auto scrollbar-custom">
                        <div class="w-full h-full justify-center items-center flex flex-col rounded-2xl p-10 gap-5 font-semibold">
                            <form method="" action="" class="w-full h-full flex flex-col">
                                <div class="mb-8">
                                    <label for="titleID" class="text-xl font-semibold ml-3">ASSUNTO:</label><br>
                                    <input type="text" name="title" id="titleID" class="bg-white rounded-xl w-full h-10 outline-none pl-3 focus:shadow-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                                </div>
                                <div class="h-50 mb-8">
                                    <label for="descriptionID" class="text-xl font-semibold ml-3">DESCRIÇÃO:</label><br>
                                    <textarea rows="6" type="text" name="description" id="descriptionID" placeholder="Escreva uma breve descrição aqui...(Opcional)" class="bg-white resize-none rounded-xl w-full p-3 outline-none h-8/10 focus:shadow-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition"></textarea>
                                </div>
                                <div class="mb-10">
                                    <div class="ml-3 font-semibold">ANEXOS:</div>
                                    <button id="anexosID" class="bg-white rounded-xl w-45 h-12 flex justify-center items-center cursor-pointer hover:bg-gray-200 hover:shadow-xl">ADICIONAR ANEXOS</button>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" name="submitEmail" id="submitEmailID" class="w-4 h-4 cursor-pointer">
                                    <label for="submitEmailID" class="ml-2 font-semibold text-xl cursor-pointer">Deseja enviar uma cópia desse aviso por e-mail?</label>
                                </div>
                                <div class="w-full flex justify-center mt-auto">
                                    <button type="submit" class="bg-white rounded-xl w-50 h-12 flex justify-center items-center cursor-pointer hover:bg-gray-200 hover:shadow-xl">
                                        ...
                                        <div class="font-semibold">ADICIONAR AVISO</div>
                                    </button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="w-full h-full">
                    <h2 class="font-semibold text-center text-xl mb-2">TODOS OS AVISOS:</h2>
                    <div class="w-full h-full rounded-2xl shadow-xl bg-sky-600/35 overflow-y-auto scrollbar-custom">
